...
# Референсы — все DLL из dependencies. Если есть _public — берём её, обычную исключаем
# (одинаковая identity "Assembly-CSharp" не должна попадать дважды). Консистентно с build-plugin.
